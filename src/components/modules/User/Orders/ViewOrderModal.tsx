...
export function ViewOrderModal({ orderID }: { orderID: string }) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[1000px] max-h-[calc(100vh-40px)] overflow-y-auto">
                ...
                <div className="grid gap-4">
                    {orderLoading ? <TableLoader rows={5} columns={1} /> : (
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={field.onChange} defaultValue={field.value ?? undefined} disabled={true}>
                                                        <FormControl>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input type="number" disabled={true} placeholder="Enter shipping cost"
                                                            {...field}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input className="py-6 px-4 shadow-none placeholder:text-gray-500" {...field} disabled placeholder="Enter your full name" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                                ...
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <div className="relative">
                                                            <Input className="py-6 pl-4 pr-16 shadow-none placeholder:text-gray-500" disabled placeholder="Ex. 01988474979" {...field} />
                                                        </div>
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input className="py-6 px-4 shadow-none placeholder:text-gray-500" disabled placeholder="Enter your full address" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input className="py-6 px-4 shadow-none placeholder:text-gray-500" disabled placeholder="Enter district name" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input className="py-6 px-4 shadow-none placeholder:text-gray-500" disabled placeholder="Enter city name" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input className="py-6 px-4 shadow-none placeholder:text-gray-500" disabled placeholder="Enter postal code" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
